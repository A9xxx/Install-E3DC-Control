...
MANUFACTURER_2024_MIRROR_READ_REQUEST_TYPES = {
    ...
    "WB_REQ_PM_POWER_L1": RscpType.Nil,
    "WB_REQ_PM_POWER_L2": RscpType.Nil,
    "WB_REQ_PM_POWER_L3": RscpType.Nil,
...
MANUFACTURER_2024_MIRROR_READ_RESPONSE_TYPES = {
    ...
    "WB_PM_POWER_L1": RscpType.Double64,
    "WB_PM_POWER_L2": RscpType.Double64,
    "WB_PM_POWER_L3": RscpType.Double64,
...
def decode_wb_extern_data_alg(value, *, age_s=0.0, max_age_s=10.0) -> dict:
    ...
    result.update({
        ...
        # 0x40 wird ausschließlich als Abort-/Disabled-Status gespiegelt.
        # Daraus folgt weder ein Überlastschutz- noch ein Standby-Nachweis.
        "abort_or_disabled": bool(flags & 0x40),
        "valid": True,
        "reason": "ok",
        "flags": flags,
        "raw_hex": raw.hex(),
