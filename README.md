...
> **Neu in 5.4.3b Stable:** Der Hotfix erhält den geprüften Installationsbenutzer über beide versiegelten Prozesswechsel und akzeptiert den standardmäßigen root-eigenen Debian-Lockroot mit Sticky-Bit. Die EMS-Regelung entspricht unverändert 5.4.3.
...
> `E3DC_IMAGE_TAG=v5.4.3b` in `.env` gesetzt. `config --images` zeigt vor dem
