...
**Einmalige Ausnahme für Version 5.3.2b:** Der erste Wechsel auf 5.4.1a
...
**Docker-Rückfall von v5.4.1a auf den veröffentlichten Docker-Rollback-Root:**
```bash
(
  set -euo pipefail
  TAG=v5.3.2b
...
- **E3DC-Control installieren oder aktualisieren:**
  ...
  - Ausnahme: Für den einmaligen Wechsel von 5.3.2b auf 5.4.1a den
