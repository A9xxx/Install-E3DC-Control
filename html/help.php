...
<div class="help-header text-center">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-success text-light">v5.4.3a Stable</span>
        </div>
    ...
    <div class="row" id="faqContainer">
        <div class="col-12 faq-item" data-tags="docker image stable rollback update">
            <div class="card bg-card border-0 shadow-sm"><div class="card-body">
                ...
                <p>Die mitgelieferte Compose-Datei verwendet standardmäßig <code>image: "ghcr.io/a9xxx/install-e3dc-control:${E3DC_IMAGE_TAG:-latest}"</code>. Ohne Pin folgt sie dem geprüften Stable-Tag <code>latest</code>. Ein fester Tag bleibt bei <code>pull</code> absichtlich fest; für einen bewussten Pin wird zum Beispiel <code>E3DC_IMAGE_TAG=v5.4.3a</code> in <code>.env</code> gesetzt.</p>
...
sudo docker compose logs --tail=80 e3dc-control</pre>
        ...
        <h4 class="mb-4 text-accent"><i class="fas fa-layer-group me-2"></i>Stable 5.4.3a: Sicherer Bare-Metal-Updateübergang</h4>
        <div class="col-12 faq-item" data-tags="5.4.3a stable update bare-metal installer sicherheit">
            <div class="card bg-card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">
                        <span class="tag">5.4.3a</span>
                        Was bringt das Stable-Release 5.4.3a?
                    </h5>
                    <ul>
                        <li><strong>Hotfix 5.4.3a:</strong> Der bereits geprüfte Installationsbenutzer bleibt über beide versiegelten Bare-Metal-Prozesswechsel gebunden. Dadurch kann der Ziel-Finalizer den Releasewechsel abschließen, ohne lokale Rollenmetadaten in den unveränderlichen Commit-Snapshot zu kopieren.</li>
